...
export interface VehicleChargeState {
  ...
  carType?: string | null; // Model reported by the vehicle adapter
  exteriorColor?: string | null; // Manufacturer paint name
  wheelType?: string | null; // Manufacturer wheel configuration
