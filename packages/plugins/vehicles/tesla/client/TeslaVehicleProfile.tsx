...
function AlloyWheel({ cx }: { cx: number }) {
  ...
  return (
    <g>
      ...
      {spokes}
      <circle cx={cx} cy="183" r="8" fill="#171b21" stroke="#d8dde4" strokeWidth="2" />
    </g>
  );
}
 ...
 *
 * The current profile matches the Fleet API configuration validated during the
 * visual POC: pre-Highland Model 3, Deep Blue Metallic and silver 19-inch wheels.
 * Keeping this as SVG makes the dashboard renderer-free and cheap on mobile.
 */
export function TeslaVehicleProfile({ vehicleId }: TeslaVehicleProfileProps) {
  return (
    ...
    >
      ...
      <path d="M307 111 L485 111" stroke="#b8c1ca" strokeWidth="2" opacity="0.65" />
      ...
      <path d="M92 151 L139 140 L170 145 L137 158 Z" fill="#dfeaff" opacity="0.9" />
      ...
      <path d="M286 111 L267 103 L250 110 L263 116 Z" fill="#174ebc" stroke="#071a45" strokeWidth="2" />
