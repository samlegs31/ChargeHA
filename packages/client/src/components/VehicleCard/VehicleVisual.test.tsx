...
describe("vehicle visual", () => {
  it("selects only an exact known model, paint and wheel combination", () => {
    expect(vehicleImageSource({
      carType: "Model_Y",
  ...
  it("falls back to the neutral silhouette after an image error", () => {
    const state = {
      carType: "model3",
      exteriorColor: "DeepBlue",
      wheelType: "StilettoRefresh19",
